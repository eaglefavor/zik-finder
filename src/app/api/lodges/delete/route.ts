...
// Initialize Supabase Admin client to bypass RLS for fetching (we verify ownership manually)
const supabaseAdmin = createClient(
  process.env.NEXT_PUBLIC_SUPABASE_URL!,
  process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY! // Ideally Service Role, but Anon works if RLS allows select
);
