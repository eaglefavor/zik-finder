        ...
        {suspendedLodge && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div className="bg-white w-full max-w-sm rounded-[32px] p-6 shadow-2xl relative overflow-hidden animate-in fade-in zoom-in duration-200">
              ...
              <button 
                onClick={() => setSuspendedLodge(null)}
              ...
              <div className="text-center mb-6 pt-4">
                ...
                <p className="text-sm text-gray-500 font-medium mt-2 max-w-[260px] mx-auto">
                  Your listing <strong>&quot;{suspendedLodge.title}&quot;</strong> has been temporarily suspended.
                </p>
              </div>
                      ...
                      {studentLeads[lodge.id]?.status === 'unlocked' ? (
                        <>
                          ...
                          <button 
                            ...
                            onClick={() => {
                              window.open(`https://wa.me/234${studentLeads[lodge.id].phone?.substring(1)}?text=Hello, I am interested in ${lodge.title}`);
                            }}
                          >
